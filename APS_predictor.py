...
if runmapperplus:
    ...
    if not Sample_data:
        ...
        for i in range(7):
            ...
            #cols = st.columns((1, 1))
            res.append(number_input('Resolution',min_value=1, max_value=100,step=1,value=8))
            gn.append(number_input('Gain',min_value=0.0000001, max_value=0.9999999,value=0.6))
